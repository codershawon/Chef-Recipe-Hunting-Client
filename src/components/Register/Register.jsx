...
const Register = () => {
    ...
    const handleRegister = (e) => {
      ...
      if (password !== confirmPassword) {
        setError(toast.error("Your password didn't match! Please provide password exactly."));
        return;
      } else if (password.length < 6) {
        setError(
          toast.error("Your given password length is less than 6 character. Please provide password more than 6 character")
        );
        return;
      }
      ...
      <div className="form">
        ...
        <form onSubmit={handleRegister} className="formDetails">
         ...
         <h2 className='mb-1'>Photo URL</h2>
          ...
          <button className="button w-full mt-8 font-semibold">Create an account</button>
